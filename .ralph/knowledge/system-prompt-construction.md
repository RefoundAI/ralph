...
tags: [prompt, system-prompt, claude, client, context, iteration]
created_at: "2026-02-18T00:00:00Z"
---

The system prompt is built dynamically in `claude/client.rs` each iteration. It assembles optional context sections in this order:
